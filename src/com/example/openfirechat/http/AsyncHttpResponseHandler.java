...
public class AsyncHttpResponseHandler {
    ...
    protected boolean mJsonResponse = false;
    ...
    public AsyncHttpResponseHandler(Object arg) {
    	this();
    	this.arg1 = arg;
    }
    
    public AsyncHttpResponseHandler(boolean json) {
    	this();
    	this.mJsonResponse = json;
    }
    
//    public AsyncHttpResponseHandler(Object arg, boolean json) {
//    	this();
//    	this.arg1 = arg;
//    	this.mJsonResponse = json;
//    }
    
    public AsyncHttpResponseHandler(Context context, boolean json) {
    	this();
    ...
    public void onSuccessJson(JSONObject json) {}
    ...
    protected void handleSuccessMessage(String responseBody) {
    	...
    	if (!mJsonResponse)
    		...
    		try {
    			...
    			// Trying this silly method from ERROR: 
    			// 	android.util.AndroidRuntimeException: 
    			// 	Calling startActivity() from outside of an Activity  
    			// 	context requires the FLAG_ACTIVITY_NEW_TASK flag. 
    			// 	Is this really what you want?
    			
    			// We MAY in any context, don't do this check.
//    			if (mContext instanceof Activity)
//    				SApp.getInstance().verify(mContext, json);
    			onSuccessJson(json);
    		} catch (Exception e) {
